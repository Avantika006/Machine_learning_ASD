...
# SUPPORT VECTOR MACHINES CLASSIFICATION USING BREAST CANCER DATASET
# In[16]:
...
y_pred_proba = clf.predict_proba(X_test)[:, 1]  # Get the predicted probabilities for the positive class
