...
precision = []
roc_auc_scores = []
# Lists to store false positive rates, true positive rates, and AUCs for each fold
all_fpr = []
all_tpr = []
all_auc = []
...
for fold, (train_index, test_index) in enumerate(kf.split(X, y), 1):
    ...
    # Calculating the false positive rate, true positive rate, and AUC for this fold
