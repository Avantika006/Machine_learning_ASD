...
# Categorical columns
cat_col = [col for col in features.columns if features[col].dtype == 'object' and col in features]
print('Categorical columns :',cat_col)
# Numerical columns
num_col = [col for col in features.columns if features[col].dtype != 'object' and col in features]
